...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RaneNetwork") type = RaneNetwork;
    if(strType == "RaneNetworkVariable") type = RaneNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RaneNetwork) s = "RaneNetwork";
    if(type == RaneNetworkVariable) s = "RaneNetworkVariable";
