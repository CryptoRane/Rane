    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RAN-light"), QVariant("light"));
    ui->theme->addItem(QString("RAN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RAN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RAN-traditional"), QVariant("trad"));
