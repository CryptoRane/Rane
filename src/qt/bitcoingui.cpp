    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Rane Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rane address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rane: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Rane Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rane Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rane Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rane addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rane addresses"));
    ...
    openAction->setStatusTip(tr("Open a rane: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rane Core help message to get a list with possible Rane Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Rane Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rane network", "", count));
}
...
{
    QString strTitle = tr("Rane Core"); // default title
