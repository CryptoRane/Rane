    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rane Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rane Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rane-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Rane in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RAN, 0.1 RAN, 1 RAN and 10 RAN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ranecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://ranecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rane Core is shutting down...") + "<br /><br />" +
