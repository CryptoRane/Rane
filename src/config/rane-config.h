/* src/config/rane-config.h.  Generated from rane-config.h.in by configure.  */
/* src/config/rane-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RANE_CONFIG_H

#define RANE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/ranecoin/rane/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rane Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rane Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ranecore"
